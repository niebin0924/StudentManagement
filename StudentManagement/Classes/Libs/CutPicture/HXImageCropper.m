...
- (id)initWithCropImage:(UIImage*)cropImage cropSize:(CGSize)cropSize {
    ...
    if(self)
    {
        ...
        _cropRect = CGRectMake(([[UIScreen mainScreen] bounds].size.width-cropSize.width)/2, ([[UIScreen mainScreen] bounds].size.height - 64 - cropSize.height)/2, cropSize.width, cropSize.height);
